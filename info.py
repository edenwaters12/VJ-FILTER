...
URL = "https://d-office-robot-3y2r.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://d-office-robot-3y2r.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://d-office-robot-3y2r.onrender.com".format(FQDN)
else:
    URL = "https://d-office-robot-3y2r.onrender.com/".format(FQDN)
