...
URL = "https://vjbot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vjbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vjbot.onrender.com".format(FQDN)
else:
    URL = "https://vjbot.onrender.com/".format(FQDN)
