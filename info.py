...
URL = "https://doffice-edenwaters12.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://doffice-edenwaters12.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://doffice-edenwaters12.koyeb.app".format(FQDN)
else:
    URL = "https://doffice-edenwaters12.koyeb.app/".format(FQDN)
