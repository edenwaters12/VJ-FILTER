...
URL = "https://file-to-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://file-to-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://file-to-bot.onrender.com/".format(FQDN)
else:
    URL = "https://file-to-bot.onrender.com/".format(FQDN)
